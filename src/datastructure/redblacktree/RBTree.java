...
public class RBTree<T extends Comparable<T>> {
    ...
    public T maximum() {
        RBTNode<T> maximum = maximum(mRoot);
        if(maximum != null){
            return  maximum.key;
        }
        return null;
    ...
    public T minimum() {
        RBTNode<T> maximum = minimum(mRoot);
        if(maximum != null){
            return  maximum.key;
        }
        return null;
    ...
    /**
     * 找节点(x)的后继结点。即，查找"红黑树中数据值大于该节点"的"最小节点"。
     * @param x
     * @return
     */
    ...
    /**
     * 节点(x)的前节点。即，查找"红黑树中数据值小于该节点"的"最大节点"。
     * @param x
     * @return
     */
